...
public class Restaurant {
	...
	/*
	 * input: ["Chinese", Japanese"] - jsonarray output: "Chinese, Japanese" - a
	 * big string
	 */
	...
	/*
	 * input: "Chinese, Japanese" - a big string output: ["Chinese", Japanese"]
	 * - jsonarray
	 */
	public static JSONArray stringToJSONArray(String str) {
		try {
			// if neglect [ and ], it will be recognized as an jasonobject
