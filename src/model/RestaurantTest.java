...
public class RestaurantTest {
	...
	// set up function, name must be setup, otherwise test fixture won't run it
	// use @BeforeClass and @AfterClass to let setUpClass() run only one time and can be used for all the test
	   public void setUp() {
